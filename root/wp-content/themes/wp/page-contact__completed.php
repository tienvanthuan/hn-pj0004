...
$messageCompleted = get_field('completed', 'option');
$messageCompletedTitle = $messageCompleted['completed_title'];
$messageCompletedContent = $messageCompleted['completed_content'];
...
<main class="p-contact is-completed">
	<?php if(!empty($urlMap)) :?>
		...
		<div class="l-container">
			<div class="p-contact2__inner">
				...
				<div class="p-contact2__block p-contact2__block2 js-animation fadeInUp">
					<div class="c-form1">
						<?php if(!empty($messageCompletedTitle)) :?>
						<p class="c-form__ttl1"><?php echo $messageCompletedTitle;?></p>
						<?php endif;?>
						<?php if(!empty($messageCompletedContent)) :?>
						<p class="c-form__text1"><?php echo $messageCompletedContent;?></p>
						<?php endif;?>
						<a href="<?php echo home_url('/'); ?>" class="c-btn1 is-center"><?php _e('TOP','mizuki');?></a>
